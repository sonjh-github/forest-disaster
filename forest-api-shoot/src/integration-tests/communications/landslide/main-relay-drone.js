...
export default definition({
  ...
  result: () => ({ deviceId: "MAIN-RELAY-001", status: "operating", observedAt: now(), position: sitePoint("landslide", 180, 220, 180), links: [{ channel: "tvws", signalStrengthDbm: -62, latencyMs: 35 }] }),
});
