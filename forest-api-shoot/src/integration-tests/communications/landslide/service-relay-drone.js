...
export default definition({
  ...
  result: () => ({ deviceId: "SERVICE-RELAY-001", status: "operating", observedAt: now(), position: sitePoint("landslide", 80, -180, 120), links: [{ channel: "wifi", signalStrengthDbm: -58, latencyMs: 18 }] }),
});
